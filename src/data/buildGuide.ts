        ...
        steps: [
          ...
          },
          {
            ...
            instructions: [
              ...
              'In the **Assign** node, add the first assignment:',
              'Set **Target**: **Request.Headers**',
              'Set **Value**: **ListAppend(Request.Headers, BuildHttpHeader("Authorization", "Bearer " + Site.OpenAI_APIKey))**',
              'Add a second assignment in the same **Assign** node:',
              'Set **Target**: **Request.Headers**',
              'Set **Value**: **ListAppend(Request.Headers, BuildHttpHeader("Content-Type", "application/json"))**',
